-- OLD:
-- NDefines.NMilitary.INFRASTRUCTURE_MOVEMENT_SPEED_IMPACT = -0.09
...
NDefines.NMilitary.STRATEGIC_SPEED_INFRA_MAX = 60.0                 -- Additional speed of strategic redeployment on max-level infrastructure
